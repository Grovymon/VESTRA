...
int main(int argc, char* argv[]) {
    ...
    QCoreApplication::setApplicationName(QStringLiteral("Vestra Slides"));
    ...
    vestra::logging::Logger::install(QStringLiteral("slides"));
    ...
    const QCommandLineOption fileOption(QStringLiteral("file"), QStringLiteral("Presentation path"),
                                        QStringLiteral("path"));
