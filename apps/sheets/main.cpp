...
int main(int argc, char* argv[]) {
    ...
    QCoreApplication::setApplicationName(QStringLiteral("Vestra Sheets"));
    ...
    vestra::logging::Logger::install(QStringLiteral("sheets"));
    ...
    const QCommandLineOption fileOption(QStringLiteral("file"), QStringLiteral("Workbook path"),
                                        QStringLiteral("path"));
